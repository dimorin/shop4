		...
		<div class="container">
			<div class="row">
				<div class="col-sm-10 col-md-8 col-lg-4 m-l-r-auto">
					<!-- block1 -->
					<div v-for="(product,i) in firstColumn" :key="i" class="block1 hov-img-zoom pos-relative m-b-30">
				...
				<div class="col-sm-10 col-md-8 col-lg-4 m-l-r-auto">
					<!-- block1 -->
					<div v-for="(product,i) in secondColumn" :key="i" class="block1 hov-img-zoom pos-relative m-b-30">
						<img :src="product.image" alt="IMG-BENNER">
						<div class="block1-wrapbtn w-size2">
							<!-- Button -->
                            <router-link to="/" class="flex-c-m size2 m-text2 bg3 hov1 trans-0-4">
